	...
	*/
	...
	public function enqueue_scripts() {
		...
		$I18N = array(
			...
			'major_releases_label_on_status'              => __( 'Major release updates are now turned on.', 'stops-core-theme-and-plugin-updates' ),
			'major_releases_label_off'             => __( 'Disable Major Releases', 'stops-core-theme-and-plugin-updates' ),
			'major_releases_label_off_status'             => __( 'Major release updates are now turned off.', 'stops-core-theme-and-plugin-updates' ),
			...
			'minor_releases_label_on_status'              => __( 'Minor release updates are now turned on.', 'stops-core-theme-and-plugin-updates' ),
			'minor_releases_label_off'             => __( 'Disable Minor Releases', 'stops-core-theme-and-plugin-updates' ),
			'minor_releases_label_off_status'              => __( 'Minor release updates are now turned off.', 'stops-core-theme-and-plugin-updates' ),
