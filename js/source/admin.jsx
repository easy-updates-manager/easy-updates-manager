...
import AwesomeComponent from './components/hello.jsx';
...
jQuery( document ).ready( function( $ ) {        
    function eum_checkbox_save( $checkbox ) {
        var checkbox_id = $checkbox.attr( 'id' );
         ...
         $.each( $checkbox, function() {
             ...
             var data_context = checkbox.data( 'context' );
             var data_action = checkbox.data( 'action' );
             var data_checked = checkbox.prop('checked');
             if ( data_checked ) {
                data_checked = 'on';  
             } else {
                data_checked = 'off';
             }
             var data_val = checkbox.val();
    ...
    function eum_toggle_main( $checkbox ) {
        if( $checkbox.is( ':checked' ) ) {
            var $checkboxes_to_enable = $( ".main-updates input[type='checkbox']" );
            ...
            $( $checkbox ).prop( 'disabled', false );
            var $checkboxes_to_disable = $( ".main-updates input[type='checkbox']" );
    ...
    $( '.dashboard-item' ).on( 'change', function( e ) {
        ...
        var $radio_boxes = $input_wrapper.find( 'input[type="radio"]:checked' );
        ...
        var $checked_boxes = $input_wrapper.find( 'input[type="checkbox"]:checked' );
        var $unchecked_boxes = $input_wrapper.find( 'input:checkbox:not(:checked)' );
