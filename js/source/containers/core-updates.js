...
class CoreUpdates extends Component {
	constructor( props ) {
		super( props );
	...
	render() {
		...
		return (
			<div className="eum-section">
				<h3>{mpsum.I18N.core_updates}</h3>
				<p className="eum-description">
					{mpsum.I18N.core_updates_description}
				</p>
				<p className="eum-status">{'on' == options.core_updates ? mpsum.I18N.core_updates_label_on_status : mpsum.I18N.core_updates_label_off_status }</p>
				{ ! this.state.loading &&
...
export default connect( mapStateToProps, { saveOptions } )(CoreUpdates);
